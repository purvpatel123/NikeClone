...
const Hero = () => {
  ...
  //   at xl screen size (>=1280px) the flex direction
  //  changes to row and at other screen sizes it changes to column
   ...
   justify-center min-h-screen gap-10 max-container">
    ...
    max-xl:padding-x pt-28">
        ...
        text-slate-gray text-lg leading-8 mt-6 mb-14
